...
object ReststopRecommendMenuData {
    val menuList = listOf(
        ...
        ReststopMenu("000289", "탄천(논산)휴게소", "청주본가 왕갈비탕", "깊은 맛의 갈비와 청주의 전통을 담은"),
        ...
        ReststopMenu("000401", "보성녹차(영암)휴게소", "벌교꼬막비빔밥", "벌교산 꼬막과 함께 즐기는 고소한 맛"),
        ...
        ReststopMenu("000064", "영종대교휴게소", "능이버섯뚝배기불고기", "깊고 풍부한 맛의 능이버섯과 불고기 조합"),
        ...
        ReststopMenu("000289", "탄천(논산)휴게소", "생생등심돈까스", "두툼한 등심으로 만든 바삭하고 고소한 돈까스"),
        ReststopMenu("000042", "추풍령(서울)휴게소", "통등심돈가스", "주문 즉시 튀기는, 감칠맛나는 정통 소스의"),
        ReststopMenu("000064", "영종대교휴게소", "왕돈가스", "넉넉한 양의 두툼한 왕돈가스로 든든한 한 끼"),
        ReststopMenu("000050", "평사(부산)휴게소", "대구따로국밥정식", "대구 10미중 하나인 얼큰한 국물의"),
        ReststopMenu("000046", "칠곡(서울)휴게소", "대구따로국밥", "국물이 일품인 칠곡 휴게소 최고 인기 메뉴"),
        ReststopMenu("000074", "청도새마을(부산)휴게소", "한우국밥", "청도에서 자란 한우를 듬뿍 넣어 깊은 맛이 나는"),
        ReststopMenu("000074", "청도새마을(대구)휴게소", "한우국밥", "청도에서 자란 한우를 듬뿍 넣어 깊은 맛이 나는"),
        ...
        ReststopMenu("000064", "광주(광주)휴게소", "소머리곰탕", "깊고 진한 국물의 소머리로 만든 전통 곰탕"),
        ReststopMenu("000064", "광주(광주)휴게소", "양곰탕", "부드러운 양고기와 진한 국물이 어우러진 곰탕"),
        ...
        ReststopMenu("000217", "치악(부산)휴게소", "원주뽕잎곤드레 영양기(氣)밥", "15가지 치악산 잡곡, 뽕잎, 곤드레로 만든"),
        ...
        ReststopMenu("000046", "장안(부산)휴게소", "기장양반정식", "꽁치구이, 제육볶음, 5가지 밑반찬 등으로 구성된"),
        ...
        ReststopMenu("000223", "문경(창원)휴게소", "문경산나물밥", "문경지역산 건나물만 사용한 건강한")
    )
}
