...
object MenuUtils {
    // 카테고리 분류 기준 정의
    private val snackKeywords = listOf("스낵", "과자", "빵", "도넛", "핫도그", "토스트", "샌드위치", "떡꼬치", "알감자","쥐포","쏘떡","통감자","가판대","소세지","꼬지어묵","꽈배기","삼진어묵","뷔페인박스","소미미","토스타","프레즐","간식", "아메리카노","핫바","로띠번","소떡","알뜰","송편","수제어묵", "소시지", "군밤","군고구마","반건조 오징어", "옥수수","사과","꼬치","스틱","타코야끼", "닭꼬치","오징어바", "문어바","카페라떼","카푸치노","라떼","마끼아또","커피","만쥬","콜드브루","빙수","회오리","해물바","크로플","닭꼬 치","모히또","밀크블랙")
